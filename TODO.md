...
[_] Частотомеры
    ...
    [_] Неавтоматическая адаптация
        [_] Перенос подсчет частоты в FreqmeterController
        [_] Добавить адаптацию
        [_] Режим авто-адаптации или специально вызвать её командой
    ...
    [_] Промежуточные вычисления в double
        ...
        [_] Температура
        [_] Аналог
        [_] Вывод конвертировать назад в float
