...
[_] protobuf
    ...
    [v] Заполнить протокол обмена
        [v] Настройки
            ...
            [_] Разрешение мониторинга перегрева/передава
    [_] Заполнить карту в KalibratorGUI
        ...
        [v] Заменить отправку стримом буферизированной отправкой, гую не очень нравится порезанное на 
            куски сообщение
        [_] Выход за рабочий диопазон/Критический перегрев-передав
        [_] Спец-соманды
            [_] Смена пароля
            [_] Очистка памяти
            [_] Сброс мониторинга
...
[_] Частотомеры
    ...
    [_] Обработка потери сиграла на входе
    [_] Вывод данных в protobuf
        [v] target / result
        [v] Частоты
        [v] Частотные выходные данныне
        [_] Аналоговые значения АЦП
        [_] Аналоговые величины
    [_] Промежуточные вычисления в double
        [v] Частота
        [v] Давление
        [v] Температура
        [_] Аналог
...
[_] Режим высокой производительнсти
    [_] Обработка частотных каналов
        [v] Отладка
        [_] Запись события выхода за максимальный допустимый предел
            Пока отключено, требуется разрешение мониторинга
