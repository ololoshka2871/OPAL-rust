...
[_] Тестирование энергопоребления и разрешения на разных опорных частотах и с разными кварцами
    https://docs.google.com/spreadsheets/d/1zffhhlEB_qlL4ln6jQgCrnld3P9O4LHwlrnUbSNGGSY/edit?usp=sharing
    [_] Режим счетчика: оценить влияние частоты опорного кварцевого резонатора на разрешение частотомера
        Есть ли разница, использовать резонатор 12MHz или 24Mhz
        [v] Создать фичу cargo, в которой бы задавалась частота опоры
        [_] Настроить соответственно 2 варианта конфигурации клоков в коде
    [_] Режим самописца: Оценить влияние опорной частоты на разрешение и энергопоребление
        [v] Создать фичу cargo, которая задяет режим работы самописца recorder-power-save, recorder-balanced, 
            recorder-performance.
        [_] Настроить соответственно 3 варианта конфигурации клоков в коде
        
[_] Обновлены версии зависимостей, тест стабильности.
