...
[_] protobuf
    ...
    [_] Заполнить протокол обмена
        [v] Настройки
            ...
            [_] Определение полного количества настраиваемых фич
                [_] Info
                    1. HW_Version/SW_Version - U32
                    2. Флаг несиправности каналов - bool[]
                    3. Флаг перегрева/передава/перегрева электроники - bool[]
                [_] Config
                    1. Serial - RW (U32)
                    ...
                    6. Пароль - строка\[10\]
                    7. Дата последней калибровки (ДДММГГГГ) https://docs.microsoft.com/ru-ru/dotnet/architecture/grpc-for-wcf-developers/protobuf-data-types#dates-and-times
                    8. Коррерция 0 по температуре и давлению - RW (f32)
                    9. Период записи давления/температуры - ms (u32) независимо
                    10. Стартовая задержка записи после включения питания - U64
                [_] Выходные значения
                    ...
                    5. Внутренний таймер, отсчитывающий секунды с момента загрузки - U64
                [_] Команды флеш
