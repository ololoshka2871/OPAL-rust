...
[_] QuardSPI
    ...
    [_] Собственная реализация методом копи-пасты с необходимыми модицикациями
        ...
        [_] Избавиться от копирования из выделенного региона в буфер, затем из буфера в USB
            ...
            [_] Копирование в буфер конечной точки с использованием DMA
        [_] Убрать регион памяти `WRITER_TEST_AREA`
