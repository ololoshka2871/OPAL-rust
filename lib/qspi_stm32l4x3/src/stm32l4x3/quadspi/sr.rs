...
use crate::stm32l4x3::{
    ...
    generics::{Readable, RegisterSpec, Resettable, R as hR},
};

#[doc = "Register `SR` reader"]
pub struct R(hR<SR_SPEC>);
impl core::ops::Deref for R {
    type Target = hR<SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<hR<SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: hR<SR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `FLEVEL` reader - FIFO level"]
pub struct FLEVEL_R(FieldReader<u8, u8>);
impl FLEVEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        FLEVEL_R(FieldReader::new(bits))
    }
}
...
pub struct BUSY_R(FieldReader<bool, bool>);
impl BUSY_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        BUSY_R(FieldReader::new(bits))
    }
}
...
pub struct TOF_R(FieldReader<bool, bool>);
impl TOF_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TOF_R(FieldReader::new(bits))
    }
}
...
pub struct SMF_R(FieldReader<bool, bool>);
impl SMF_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        SMF_R(FieldReader::new(bits))
    }
}
...
pub struct FTF_R(FieldReader<bool, bool>);
impl FTF_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        FTF_R(FieldReader::new(bits))
    }
}
...
pub struct TCF_R(FieldReader<bool, bool>);
impl TCF_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TCF_R(FieldReader::new(bits))
    }
}
...
pub struct TEF_R(FieldReader<bool, bool>);
impl TEF_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        TEF_R(FieldReader::new(bits))
    }
}
